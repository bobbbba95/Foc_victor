...
void motor_left_cc_set          (uint16 a_duty, uint16 b_duty, uint16 c_duty); // 先将上一次cc1镜像到cc0，再使用本次duty更新cc1
...
void motor_right_cc_set         (uint16 a_duty, uint16 b_duty, uint16 c_duty); // 先将上一次cc1镜像到cc0，再使用本次duty更新cc1
